...
import com.qq.singleangelvip.contact.qrcard.core.RegularExpression;

import java.util.ArrayList;
import java.util.HashMap;

/**
 * Created by singl on 2017/4/19.
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(SaveContactActivity.this,MainActivity.class);
        ...
        CallingCard cc = new RegularExpression().regularEp(rt);
        Name.setText(cc.getName());
        NickName.setText(cc.getNickName());
        company.setText(cc.getCompany());
        im.setText(cc.getIm());
        note.setText(cc.getNote());

        phone.setText(cc.getTel());
        phone2.setText(cc.getMobile());
        address.setText(cc.getAddress());
        email.setText(cc.getAddress());

        /**
        ArrayList<HashMap<String, Object>> listItem = new ArrayList<HashMap<String, Object>>();

        final String[] itemTitle = {"Name","NickName","Tel","Mobile","QQ","Email","Company","Address","Note"};
        String[] itemText = {cc.getName(),cc.getNickName(),cc.getTel(),cc.getMobile(),cc.getIm(),cc.getEmail(),cc.getCompany(),cc.getAddress(),cc.getNote()};
        ...
        for (HashMap<String, Object> list : listItem){
